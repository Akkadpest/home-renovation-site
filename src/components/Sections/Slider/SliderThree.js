        ...
        >
          <SwiperSlide className="relative">
            ...
            <div className="container flex flex-col justify-center relative h-full max-sm:-mt-10">
             <h2 className="section_tit_three lg:w-2/3 text-white heading1" style={{ "--i": 6 }}>
  Quick & Reliable HVAC Services in Dubai
</h2>
<p className="section_desc mt-4 text-white body2" style={{ "--i": 7 }}>
  Whether your AC isn’t cooling or you need urgent heating repairs, our Dubai HVAC experts provide quick, dependable service all year round.
</p>
