          ...
          <div className="container flex items-center justify-between h-full">
            <h1>
              <Link href="/" className="logo flex items-center gap-3">
                <Image width={1000} height={1000} src="/images/on-logo.png" className="flex-shrink-0 w-10" alt="logo" />
                <strong className="heading4"></strong>
              </Link>
            </h1>
              ...
              <li className="flex items-center gap-3">
                <Link href="mailto:hi.avitex@gmail.com" className="flex items-center gap-3 group">
                  ...
                  <div className="max-lg:hidden">
                    ...
                    <strong className="heading6 block mt-0.5">hi.avitex@gmail.com</strong>
                  </div>
                </Link>
              </li>
